...
<CardGroup cols={2}>
  <Card title="ETL Pipeline" icon="arrow-progress" href="/etl/overview">
    Learn how to extract, transform, and load data
  </Card>
  
  <Card title="Data Model" icon="diagram-project" href="/data-model/star-schema">
    Explore the star schema and analytics model
  </Card>
  
  <Card title="SQL Scripts" icon="file-code" href="/scripts/bronze">
    Dive into the Bronze, Silver, and Gold layer scripts
  </Card>
  
  <Card title="Testing" icon="vial" href="/testing/data-quality">
